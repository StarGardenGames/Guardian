/// @desc Checks whether an input is pressed
...
with(oInput){
	// I want checkPressed(vk_*) to work without mapping for convenience
	...
	if(inputInstanceHasAccess(other.id) && ds_map_exists(pressed, input_name)){
		return pressed[? input_name];
	}
}
return false